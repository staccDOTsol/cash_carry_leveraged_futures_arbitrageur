...
from swaps.connection.impl.private_def import ConnectionState
...
class WebsocketManage:
    ...
    def __init__(self, api_key, secret_key, uri, request):
        self.__thread = None
        self.__market_url = "wss://api.hbdm.com/swap-ws"
        self.__trading_url = "wss://api.hbdm.com/swap-ws/" + request.api_version
        self.__mbp_feed_url = "wss://api.hbdm.com/feed"
