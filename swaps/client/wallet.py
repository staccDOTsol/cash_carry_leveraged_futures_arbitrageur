...
class WalletClient(object):
    ...
    def get_deposit_withdraw(self, op_type: 'str', currency: 'str' = None, from_id: 'int' = None, size: 'int' = None,
        ...
        from swaps.service.wallet.get_deposit_withdraw import GetDepositWithdrawService
    ...
    def post_create_withdraw(self, address: 'str', amount: 'float', currency: 'str', fee: 'float',
        ...
        from swaps.service.wallet.post_create_withdraw import PostCreateWithdrawService
    ...
    def post_cancel_withdraw(self, withdraw_id: 'int') -> int:
        ...
        from swaps.service.wallet.post_cancel_withdraw import PostCancelWithdrawService
    ...
    def get_account_deposit_address(self, currency: 'str') -> list:
        ...
        from swaps.service.wallet.get_account_deposit_address import GetAccountDepositAddressService
    ...
    def get_account_withdraw_quota(self, currency: 'str') -> list:
        ...
        from swaps.service.wallet.get_account_withdraw_quota import GetAccountWithdrawQuotaService
    ...
    def get_sub_user_deposit_history(self, sub_uid: 'int', currency: 'str' = None,
        ...
        from swaps.service.wallet.get_sub_user_deposit_history import GetSubUserDepositHistoryService
    ...
    def get_sub_user_deposit_address(self, sub_uid: 'int', currency: 'str') -> list:
        ...
        from swaps.service.wallet.get_sub_user_deposit_address import GetSubUserDepositAddressService
    ...
    def get_account_withdraw_address(self, currency: 'str', chain: 'str'=None, note: 'str'=None, limit: 'int' = 100,
        ...
        from swaps.service.wallet.get_account_withdraw_address import GetAccountWithdrawAddressService
