...
class MarginClient(object):
    ...
    def post_transfer_in_margin(self, symbol: 'str', currency: 'str', amount: 'float') -> int:
        ...
        from swaps.service.margin.post_transfer_in_margin import PostTransferInMarginService
    ...
    def post_transfer_out_margin(self, symbol: 'str', currency: 'str', amount: 'float') -> int:
        ...
        from swaps.service.margin.post_transfer_out_margin import PostTransferOutMarginService
    ...
    def get_margin_account_balance(self, symbol: 'str') -> list:
        ...
        from swaps.service.margin.get_margin_account_balance import GetMarginAccountBalanceService
    ...
    def post_create_margin_order(self, symbol: 'str', currency: 'str', amount: 'float') -> int:
        ...
        from swaps.service.margin.post_create_margin_order import PostCreateMarginOrderService
    ...
    def post_repay_margin_order(self, loan_id: 'int', amount: 'float') -> int:
        ...
        from swaps.service.margin.post_repay_margin_order import PostRepayMarginOrderService
    ...
    def get_margin_loan_orders(self, symbol: 'str', start_date: 'str' = None, end_date: 'str' = None,
        ...
        from swaps.service.margin.get_margin_loan_orders import GetMarginLoanOrdersService
    ...
    def get_margin_loan_info(self, symbols: 'str'=None) -> list:
        ...
        from swaps.service.margin.get_margin_loan_info import GetMarginLoanInfoService
    ...
    def get_cross_margin_loan_info(self) -> list:
        ...
        from swaps.service.margin.get_cross_margin_loan_info import GetCrossMarginLoanInfoService
    ...
    def post_cross_margin_transfer_in(self, currency: 'str', amount:'float') -> int:
        ...
        from swaps.service.margin.post_cross_margin_transfer_in import PostCrossMarginTransferInService
    ...
    def post_cross_margin_transfer_out(self, currency: 'str', amount:'float') -> int:
        ...
        from swaps.service.margin.post_cross_margin_transfer_out import PostCrossMarginTransferOutService
    ...
    def post_cross_margin_create_loan_orders(self, currency:'str', amount: 'float') -> int:
        ...
        from swaps.service.margin.post_cross_margin_create_loan_orders import PostCrossMarginCreateLoanOrdersService
    ...
    def post_cross_margin_loan_order_repay(self, order_id: 'str', amount: 'float'):
        ...
        from swaps.service.margin.post_cross_margin_loan_order_repay import PostCrossMarginLoanOrderRepayService
    ...
    def get_cross_margin_loan_orders(self, currency: 'str' = None, state: 'str' = None,
        ...
        from swaps.service.margin.get_cross_margin_loan_orders import GetCrossMarginLoanOrdersService
    ...
    def get_cross_margin_account_balance(self, sub_uid:'int'=None):
        ...
        from swaps.service.margin.get_cross_margin_account_balance import GetCrossMarginAccountBalanceService
