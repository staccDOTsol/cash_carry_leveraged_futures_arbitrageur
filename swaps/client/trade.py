...
from swaps.utils.input_checker import *
...
class TradeClient(object):
    ...
    def get_feerate(self, symbols: 'str') -> list:
        ...
        from swaps.service.trade.get_feerate import GetFeeRateService
    ...
    def get_transact_feerate(self, symbols: 'str') -> list:
        ...
        from swaps.service.trade.get_transact_feerate import GetTransactFeeRateService
    ...
    def sub_order_update(self, symbols: 'str', callback, error_handler=None):
        ...
        from swaps.service.trade.sub_order_update_v2 import SubOrderUpdateV2Service
    ...
    def req_order_list(self, symbol: 'str', account_id: int, callback, order_states:'str',
        ...
        from swaps.service.trade.req_order_list import ReqOrderListService
    ...
    def req_order_detail(self, order_id: 'str', callback,
        ...
        from swaps.service.trade.req_order_detail import ReqOrderDetailService
    ...
    def get_order(self, order_id: 'int') -> Order:
        ...
        from swaps.service.trade.get_order_by_id import GetOrderByIdService
    ...
    def get_order_by_client_order_id(self, client_order_id):
        ...
        from swaps.service.trade.get_order_by_client_order_id import GetOrderByClientOrderIdService
    ...
    def get_orders(self, symbol: 'str', order_state: 'OrderState', order_type: 'OrderType' = None,
        ...
        from swaps.service.trade.get_orders import GetOrdersService
    ...
    def get_open_orders(self, symbol: 'str', account_id: 'int', side: 'OrderSide' = None,
        ...
        from swaps.service.trade.get_open_orders import GetOpenOrdersService
    ...
    def get_history_orders(self, symbol=None, start_time=None, end_time=None, size=None, direct=None)-> list:
        ...
        from swaps.service.trade.get_history_orders import GetHistoryOrdersService
    ...
    def get_match_result(self, symbol: 'str', order_type: 'OrderSide' = None, start_date: 'str' = None,
        ...
        from swaps.service.trade.get_match_results import GetMatchResultsService
    ...
    def get_match_results_by_order_id(self, order_id: 'int') -> list:
        ...
        from swaps.service.trade.get_match_results_by_order_id import GetMatchResultsByOrderIdService
    ...
    def create_order(self, symbol: 'str', account_id: 'int', order_type: 'OrderType', amount: 'float',
        ...
        from swaps.service.trade.post_create_order import PostCreateOrderService
    ...
    def cancel_order(self, symbol, order_id):
        ...
        from swaps.service.trade.post_cancel_order import PostCancelOrderService
    ...
    def cancel_orders(self, symbol, order_id_list)->BatchCancelResult:
        ...
        from swaps.service.trade.post_batch_cancel_order import PostBatchCancelOrderService
    ...
    def cancel_open_orders(self, account_id, symbols: 'str'=None , side=None, size=None)->BatchCancelCount:
        ...
        from swaps.service.trade.post_batch_cancel_open_order import PostBatchCancelOpenOrderService
    ...
    def cancel_client_order(self, client_order_id)->int:
        ...
        from swaps.service.trade.post_cancel_client_order import PostCancelClientOrderService
    ...
    def transfer_between_futures_and_pro(self, currency: 'str', amount: 'float',
        ...
        from swaps.service.trade.post_transfer_futures_pro import PostTransferFuturesProService
    ...
    def batch_create_order(self, order_config_list) -> int:
        ...
        from swaps.service.trade.post_batch_create_order import PostBatchCreateOrderService
    ...
    def sub_trade_clearing(self, symbols: 'str', callback, error_handler=None):
        ...
        from swaps.service.trade.sub_trade_clearing_v2 import SubTradeClearingV2Service
