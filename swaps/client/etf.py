...
class EtfClient(object):
    ...
    def get_etf_swap_config(self, etf_name: 'str') -> EtfSwapConfig:
        ...
        from swaps.service.etf.get_etf_swap_config import GetEtfSwapConfigService
    ...
    def get_etf_swap_list(self, etf_name: 'str', offset: 'int', size: 'int') -> list:
        ...
        from swaps.service.etf.get_etf_swap_list import GetEtfSwapListService
    ...
    def post_etf_swap_in(self, etf_name: 'str', amount: 'int') -> None:
        ...
        from swaps.service.etf.post_etf_swap_in import PostEftSwapInService
    ...
    def post_etf_swap_out(self, etf_name: 'str', amount: 'int') -> None:
        ...
        from swaps.service.etf.post_etf_swap_out import PostEtfSwapOutService
