from swaps.connection.impl.restapi_request import RestApiRequest
...
class GenericClient(object):
    ...
    def get_exchange_timestamp(self) -> int:
        ...
        from swaps.service.generic.get_exchange_timestamp import GetExchangeTimestampService
    ...
    def get_exchange_currencies(self) -> list():
        ...
        from swaps.service.generic.get_exchange_currencies import GetExchangeCurrenciesService
    ...
    def get_exchange_symbols(self) -> list():
        ...
        from swaps.service.generic.get_exchange_symbols import GetExchangeSymbolsService
    ...
    def get_reference_currencies(self, currency: 'str' = None, is_authorized_user: 'bool' = None) -> list:
        ...
        from swaps.service.generic.get_reference_currencies import GetReferenceCurrenciesService
    ...
    def get_system_status(self) -> str:
        ...
        from swaps.service.generic.get_system_status import GetSystemStatusService
        return GetSystemStatusService({}).request(**self.__kwargs)

    def get_market_status(self):
        from swaps.service.generic.get_market_status import GetMarketStatusService
