...
class SubuserClient(object):
    ...
    def post_create_subuser(self, user_list):
        ...
        params = user_list
        from swaps.service.subuser.post_create_subuser import PostSubuserCreationService
    ...
    def post_set_tradable_market(self, sub_uids, account_type: 'SubuserTradePrivilegeType',
        ...
        from swaps.service.subuser.post_tradable_market import PostTradableMarketService
    ...
    def post_set_subuser_transferability(self, sub_uids: 'str', transferrable: 'bool',
        ...
        from swaps.service.subuser.post_set_transferability import PostSetSubuserTransferability
    ...
    def post_subuser_apikey_generate(self, otp_token: 'str', sub_uid: 'int', note: 'str', permission: 'bool',
        ...
        from swaps.service.subuser.post_subuser_apikey_generation import PostSubuserApikeyGenerationService
    ...
    def get_user_apikey_info(self, uid: 'str', access_key: 'str' = None):
        ...
        from swaps.service.subuser.get_user_apikey_info import GetUserApikeyInfoService
    ...
    def post_subuser_apikey_modification(self, sub_uid: 'str', access_key: 'str', note: 'str' = None,
        ...
        from swaps.service.subuser.post_subuser_apikey_modification import PostSubuserApikeyModificationService
    ...
    def post_subuser_apikey_deletion(self, sub_uid: 'str', access_key: 'str'):
        ...
        from swaps.service.subuser.post_subuser_apikey_deletion import PostSubuserApikeyDeletionService
