...
class huobifuts(Exchange):

    def describe(self):
        return self.deep_extend(super(huobifuts, self).describe(), {
            'id': 'huobifuts',
            'name': 'Huobi Pro',
            'countries': ['CN'],
            'rateLimit': 2000,
            ...
            'accounts': None,
            'accountsById': None,
            'hostname': 'api.hbdm.com',  # api.testnet.huobi.pro
            'pro': True,
            'has': {
                'cancelOrder': True,
                'CORS': False,
            ...
            'api': {
                ...
                'private': {
                    ...
                    'post': [
                        ...
                        'cross-margin/transfer-in',
                        'cross-margin/transfer-out',
                        'cross-margin/orders/{id}/repay',
                        'futures/transfer',
                        'account/transfer',
                        'order/batch-orders',
