...
module.exports = class huobifuts extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'hostname2': 'api.hbdm.com',
            'hostname3': 'api.hbdm.com', // api.testnet.huobi.pro
            'pro': true,
            'has': {
                'cancelOrder': true,
                'CORS': false,
            ...
            'urls': {
                ...
                'api': {
                    ...
                    'private2': 'https://api.hbdm.com/swap-api/v1',
                    'private3': 'https://api.hbdm.com/api/v1',
